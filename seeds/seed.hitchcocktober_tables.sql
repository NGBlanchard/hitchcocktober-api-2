...
INSERT INTO curricula_users (user_name, password, days)
VALUES
  ...
  ('Archimboldi', '$2a$12$VsD.W/HXu8ae0Wih8Vscr.CYSefcj2fCsByOBCxWp1UISXuZaaSV.',
      {
        ...
        "meal": "Chicken and rice with a gravy train",
        "rating": 5
      },
      {
        "id": "2",
...
VALUES
  ...
  (426, "Vertigo", "A retired San Francisco detective suffering from acrophobia investigates the strange activities of an old friend's wife, all the while becoming dangerously obsessed with her.", 2722, "/obhM86qyv8RsE69XSMTtT9FdE0b.jpg", 23.011, 8.2, "1958-05-09"),
  ...
  (543, "Blackmail", "Alice's boyfriend Frank is a Scotland Yard detective who seems more interested in police work than in her. When she agrees to go out with another man, he attacks her and she defends herself and kills him. When the body is discovered, Frank is assigned to the case. He quickly discovers that Alice is the killer, but so has someone else, and they are threatening blackmail.", 88, "/xmKRYOyx3AGjlbWhkcSZFo75lIP.jpg", 6.403, 6.7, "1929-10-06"),
  ...
  (573, "Frenzy", "After a serial killer strangles several women with a necktie, London police identify a suspect—but he's the wrong man.", 339, "/4SFvqrlSigAt9tnhXFSMyKeJWQk.jpg", 15.898, 7.2, "1972-06-21"),
  ...
  (1978, "Stage Fright", "A struggling actress tries to help a friend prove his innocence when he's accused of murdering the husband of a high society entertainer.", 111, "/1W7RzrENooOXQVeYMlF8Vx3EpAk.jpg", 7.529, 6.8, "1950-02-23"),
  ...
  (4175, "Under Capricorn", "In 1831, Irishman Charles Adare travels to Australia to start a new life with the help of his cousin who has just been appointed governor. When he arrives he meets powerful landowner and ex-convict, Sam Flusky, who wants to do a business deal with him. Whilst attending a dinner party at Flusky's house, Charles meets Flusky's wife Henrietta who he had known as a child back in Ireland. Henrietta is an alcoholic and seems to be on the verge of madness.", 47, "/7cHluGXnrzwSA7Etze5pliNQ03m.jpg", 4.967, 6.4, "1949-09-08"),
  ...
  (11219, "The Trouble with Harry", "Trouble erupts in a small, quiet New England town when a man's body is found in the woods. The problem is that almost everyone in town thinks that they had something to do with his death.", 331, "/tXq2vB69rv6uqqkyiqfxci0TMgZ.jpg", 12.499, 7, "1955-10-03"),
  ...
  (31995, "Jamaica Inn", "In coastal Cornwall, England, during the early 19th Century, a young woman discovers that she's living with a gang of criminals who arrange shipwrecking for profit.", 79, "/80V3ScsMRzsuLF0T17SlRN4tiah.jpg", 6.357, 6, "1939-10-11"),
  ...
  (12684, "Sabotage", "A Scotland Yard undercover detective is on the trail of a saboteur who is part of a plot to set off a bomb in London. But when the detective's cover is blown, the plot begins to unravel.", 119, "/9DM9MPN6jtvIhqvadCFTPBQZwiW.jpg", 8.586, 6.8, "1937-01-11"),
  ...
  (35832, "The Farmer's Wife", "Successful middle-aged farmer Samuel Sweetland becomes widowed, then his daughter marries and leaves home. Deciding he wishes to remarry, Sweetland pursues some local women he considers prospects.", 24, "/hs5z3ZeUc7VXmdhkliM1nGn6d5z.jpg", 3.375, 5.8, "1930-01-04"),
  ...
  (36055, "Easy Virtue", "Larita Filton is named as correspondent in a scandalous divorce case. She escapes to France to rebuild her life where she meets John Whittaker. They are later married, but John's well-to-do family finds out Larita's secret.", 24, "/blrQSfCOBJAKxWptjRnVI3AYvH2.jpg", 3.623, 5.4, "1928-03-05"),
  ...
  (52782, "Downhill", "After public school student Roddy Berwick takes the blame for a friend's transgression and is expelled, his life goes downhill.", 21, "/p3ZTJIjcl1jBzlXfrmQXFbjvtCy.jpg", 3.234, 6.2, "1927-10-24"),
  ...
  (319841, "Sound Test for Blackmail", "The short sequence, photographed by Jack E Cox, has Hitchcock trying his best to embarrass the film's Czech lead Anny Ondra, who ends up giggling and turning her back to the camera...", 7, "/dLlSkryfsyKRpH526jcpNQgQe4p.jpg", 1.692, 6.9, "1929-01-01"),
  ...
  (414019, "The Fighting Generation", "A 1944 propaganda short film produced for the U.S. Treasury Department and intended to boost war bond sales, directed by an uncredited Alfred Hitchcock and starring Jennifer Jones as a nurse's aide.", 3, "/mCHg0oMC9uw24QeBQczgp1hkSZh.jpg", 0.681, 6.7, "1944-10-01"),
  ...
  (493439, "Blackmail (Silent Version)", "Alice White is the daughter of a shopkeeper in 1920's London. Her boyfriend, Frank Webber is a Scotland Yard detective who seems more interested in police work than in her. Frank takes Alice out one night, but she has secretly arranged to meet another man. Later that night Alice agrees to go back to his flat to see his studio. The man has other ideas and as he tries to rape Alice, she defends herself and kills him with a bread knife. When the body is discovered, Frank is assigned to the case, he quickly determines that Alice is the killer, but so has someone else and blackmail is threatened.", 2, "/oa0Ie4BA3W7WooNy1rVS58jzfxy.jpg", 0.6, 8, "1929-06-30"),
